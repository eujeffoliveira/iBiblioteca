...
-- Criação da tabela TB_LIVRO_AUTOR (relacionamento muitos para muitos)

CREATE TABLE TB_LIVRO_AUTOR (
    ID_LIVRO INT,
    ID_AUTOR INT,
    PRIMARY KEY (ID_LIVRO, ID_AUTOR),
    CONSTRAINT FK_TB_LIVRO_AUTOR_LIVRO FOREIGN KEY (ID_LIVRO) REFERENCES TBLIVRO(ID),
    CONSTRAINT FK_TB_LIVRO_AUTOR_AUTOR FOREIGN KEY (ID_AUTOR) REFERENCES TBAUTOR(ID)
);
